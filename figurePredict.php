...
$fullPath = 'convert ./data/test/test'.strval($count).'.png -background white -flatten -alpha off ./data/test/test'.strval($count).'.jpg && python3 ./cgi-bin/figure_predict.py ./data/test/test'.strval($count).'.jpg';
...
echo "<br><br><a href=./index2.php>前のページに戻る</a>";
